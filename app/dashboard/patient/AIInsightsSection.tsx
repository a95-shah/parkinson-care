...
export default function AIInsightsSection({ checkIns }: AIInsightsSectionProps) {
  ...
  return (
    <Card className="border-2 border-purple-200 bg-linear-to-br from-purple-50 to-indigo-50">
      <CardHeader>
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <CardTitle className="text-2xl text-purple-900">AI-Powered Health Insights</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-purple-900">Select Time Range:</label>
        ...
        {insight && (
          <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-purple-100">
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">{insight.medicationPatterns}</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-purple-100">
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">{insight.symptomTrends}</p>
            </div>

            {/* Wearing-Off Patterns (with disclaimer) */}
            <div className="bg-amber-50 rounded-lg p-6 shadow-sm border-2 border-amber-200">
              ...
              <div className="bg-white rounded p-4 mb-3 border border-amber-300">
              ...
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">{insight.wearingOffPatterns}</p>
            </div>
