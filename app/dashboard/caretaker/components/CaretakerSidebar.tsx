...
export function CaretakerSidebar({ activeTab, setActiveTab, className }: SidebarProps) {
  const menuItems = [
            ...
            {menuItems.map((item) => (
              <Button
                ...
                className={cn(
                  ...
                  activeTab === item.id && "bg-green-100 text-green-700 hover:bg-green-100/80 font-semibold shadow-sm"
                )}
